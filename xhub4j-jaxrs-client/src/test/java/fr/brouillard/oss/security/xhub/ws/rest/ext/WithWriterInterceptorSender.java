...
public class WithWriterInterceptorSender {
    ...
    private static String calculateJSONPayload() {
        return Json.createObjectBuilder().add("name", "Matthieu Brouillard").add("likes", "coding !!!").build().toString();
    }
}
